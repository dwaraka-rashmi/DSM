...
class EC2Cloud():
    ...
    def __init__(self):
        self.key_location = "/home/abhay/Downloads/EC2.pem"
        self.key_pair = None
        self.key_name = "EC2.pem"
        self.security_group_name = None
        self.security_group = None # This is a security group object, which boto uses
        self.region = None
        self.instances = []

        self.key_pair = ("AKIAJAFJFB7G7TUAUTDQ","w7wyv8nalbRqGBkBRzMx6vApV/9xpTj83zwUhm4l")
    ...
    def get_existing_instances(self):
        ...
        for r in self.ec2_connection.get_all_instances():
            for i in r.instances:
                # print "tag.Name", i.tags['Name']
                if i.state == "running" and i.tags['Name'] not in ["Manager"]:
